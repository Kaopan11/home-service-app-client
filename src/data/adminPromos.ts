import type { PromoDiscountType, PromotionDto, PromotionPayload } from '@/types/promo'

const CREATED = '2022-02-12T22:30:00'
const EXPIRES = '2022-06-12T22:30:00'

export const MOCK_ADMIN_PROMOS: PromotionDto[] = [
  {
    promotion_id: 1,
    code: 'HOME0202',
    discount_type: 'fixed',
...
export function cloneSeedPromos(): PromotionDto[] {
  return MOCK_ADMIN_PROMOS.map((item) => ({ ...item }))
}
